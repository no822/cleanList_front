...
const commonQuestionsData: Array<yesOrNo> = [
    {cleaningId: 'c2', text: '세탁할 빨래가 있습니까?', additionalCleaning: ['c3', 'c4', 'c5'], difficulty: 'easy', area: 'common' },
    {cleaningId: 'c3', text: '세탁이 끝난 빨래가 있습니까?', additionalCleaning: ['c4', 'c5'], difficulty: 'easy', area: 'common'},
    {cleaningId: 'c4', text: '다 마른 빨래가 있습니까?', additionalCleaning: ['c5'], difficulty: 'easy', area: 'common'},
